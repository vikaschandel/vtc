      ...
      <div class="page-content">
       ...
       <!--breadcrumb-->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item" >{{ __('Define permissions of user')}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h5>{{ __('Add Permission')}}</h5></div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{url('permission/create')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-rounded" style="margin-top:25px;">{{ __('Save')}}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
